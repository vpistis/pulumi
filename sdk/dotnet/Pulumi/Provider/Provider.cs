...
namespace Pulumi.Provider
{
    ...
    public sealed class CheckRequest
    {
        ...
        public CheckRequest(string urn, ImmutableDictionary<string, PropertyValue> olds, ImmutableDictionary<string, PropertyValue> news, int sequenceNumber)
        {
            Urn = urn;
            Olds = olds;
            News = news;
    ...
    class ResourceProviderService : ResourceProvider.ResourceProviderBase
    {
        ...
        public override async Task<Pulumirpc.CheckResponse> CheckConfig(Pulumirpc.CheckRequest request, ServerCallContext context)
        {
            try
            {
                var domRequest = new CheckRequest(request.Urn, PropertyValue.Marshal(request.Olds), PropertyValue.Marshal(request.News), request.SequenceNumber);
        ...
        {
            throw new RpcException(new Status(StatusCode.Unimplemented, "Construct and Call currently not implemented"));
        }
