...
func newLoginCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Run: cmdutil.RunFunc(func(cmd *cobra.Command, args []string) error {
			...
			if filestate.IsFileStateBackendURL(cloudURL) {
				...
				be, err = httpstate.Login(commandContext(), cmdutil.Diag(), cloudURL, insecure, displayOptions)
	...
	cmd.PersistentFlags().BoolVarP(&localMode, "insecure", "k", false, "Allow insecure server connections when using SSL")
